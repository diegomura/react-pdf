...
export interface BaseImageBackgroundProps extends NodeProps {
  /**
   * Enables debug mode on page bounding box.
   * @see https://react-pdf.org/advanced#debugging
   */
...
export interface ImageBackgroundWithSrcProp extends BaseImageBackgroundProps {
  src: SourceObject;
}

export interface ImageBackgroundWithSourceProp
  extends BaseImageBackgroundProps {
  source: SourceObject;
}
...
export interface SVGTextProps extends SVGPresentationAttributes {
...
export interface TextInputFormatting {
  type:
    | 'date'
    | 'time'
    | 'percent'
...
export interface CheckboxProps extends FormCommonProps {
...
export interface SelectAndListPropsBase extends FormCommonProps {
  sort?: boolean;
  edit?: boolean;
  multiSelect?: boolean;
  noSpell?: boolean;
...
export type SelectAndListPropsWithEdit = SelectAndListPropsBase & {
  edit: true | false;
  noSpell: boolean;
};

export type SelectAndListPropsWithNoSpell = SelectAndListPropsBase & {
  edit: boolean;
  noSpell: true | false;
};

export type SelectAndListProps =
...
export interface NoteProps extends NodeProps {
  children: string;
}
