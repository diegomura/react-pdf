...
describe('Document', () => {
  ...
  test('Should apply rotation in degrees', async () => {
  ...
  test('Should apply rotation in radians', async () => {
    const doc = new Document(dummyRoot, {});
    const page = new Page(dummyRoot, {});
  ...
  test('Should apply scaleX transform', async () => {
    const doc = new Document(dummyRoot, {});
    const page = new Page(dummyRoot, {});
  ...
  test('Should apply scaleY transform', async () => {
    const doc = new Document(dummyRoot, {});
    const page = new Page(dummyRoot, {});
  ...
  test('Should apply scale shortcut transform', async () => {
    const doc = new Document(dummyRoot, {});
    const page = new Page(dummyRoot, {});
  ...
  test('Should apply translateX transform', async () => {
    const doc = new Document(dummyRoot, {});
    const page = new Page(dummyRoot, {});
  ...
  test('Should apply translateY transform', async () => {
    const doc = new Document(dummyRoot, {});
    const page = new Page(dummyRoot, {});
  ...
  test('Should apply translate shortcut transform', async () => {
    const doc = new Document(dummyRoot, {});
    const page = new Page(dummyRoot, {});
    const view = new View(dummyRoot, {
