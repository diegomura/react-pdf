<p align="center">
  ...
  <p align="center">
    <a href="https://www.npmjs.com/package/@govind-react-pdf/renderer">
      <img src="https://img.shields.io/npm/v/@govind-react-pdf/renderer.svg" />
    </a>
...
## How to install
```sh
yarn add @govind-react-pdf/renderer
```
...
import { Document, Page, Text, View, StyleSheet } from '@govind-react-pdf/renderer';
...
import { PDFViewer } from '@govind-react-pdf/renderer';
...
```jsx
import React from 'react';
import ReactPDF from '@govind-react-pdf/renderer';
...
---
![](https://img.shields.io/npm/dt/@govind-react-pdf/renderer.svg?style=flat)
