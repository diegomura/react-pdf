...
> For more information about how this hook is used please refer to the [Using the usePDF hook](/docs/v4/advanced/on-the-fly-rendering#using-the-usepdf-hook) section
