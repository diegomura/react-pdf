...
A bookmark can be defined by the `bookmark` prop on any of the supported components ([see more](/docs/v2/components)), and can take the form of either a _String_ or a _Bookmark_ type
...
> **Protip:** If you don't want to hyphenate words at all, just provide a callback that returns the same words it receives. More information [here](/docs/v2/fonts#registerhyphenationcallback)
