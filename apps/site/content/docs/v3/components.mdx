...
| pageMode   |       Specifying how the document should be displayed when opened       |     [PageMode](/docs/v3/components#pagemode-type) |     _useNone_ |
| pageLayout |        This controls how (some) PDF viewers choose to show pages        | [PageLayout](/docs/v3/components#pagelayout-type) |  _singlePage_ |
...
| wrap        |                                                                          Enables page wrapping for this page. [See more](/docs/v3/advanced#page-wrapping)                                                                           |                                       _Boolean_ |       _true_ |
| style       |                                                                                          Defines page styles. [See more](/docs/v3/styling)                                                                                          |                               _Object_, _Array_ |  _undefined_ |
| debug       |                                                                          Enables debug mode on page bounding box. [See more](/docs/v3/advanced#debugging)                                                                           |                                       _Boolean_ |      _false_ |
| dpi         |                                                                                       Enables setting a custom DPI for page contents.                                                                                       |                                        _Number_ |         _72_ |
| id          |                                                                             Destination ID to be linked to. [See more](/docs/v3/advanced#destinations-v200)                                                                              |                                        _String_ |  _undefined_ |
| bookmark    |                                                                                 Attach bookmark to element. [See more](/docs/v3/advanced#bookmarks-v220)                                                                                 | _String_ or [Bookmark](/docs/v3/advanced#bookmark-type) |  _undefined_ |
...
| Prop name |                                  Description                                   |                                            Type |     Default |
|-----------|:------------------------------------------------------------------------------:|------------------------------------------------:|------------:|
| wrap      | Enable/disable page wrapping for element. [See more](/docs/v3/advanced#page-wrapping)  |                                       _Boolean_ |      _true_ |
| style     |                   Defines view styles. [See more](/docs/v3/styling)                    |                               _Object_, _Array_ | _undefined_ |
| render    | Render dynamic content based on context. [See more](/docs/v3/advanced#dynamic-content) |                                      _Function_ | _undefined_ |
| debug     |    Enables debug mode on view bounding box. [See more](/docs/v3/advanced#debugging)    |                                       _Boolean_ |     _false_ |
| fixed     |   Render component in all wrapped pages. [See more](/docs/v3/advanced#page-wrapping)   |                                       _Boolean_ |     _false_ |
| id        |       Destination ID to be linked to. [See more](/docs/v3/advanced#destinations-v200)       |                                        _String_ | _undefined_ |
| bookmark  |          Attach bookmark to element. [See more](/docs/v3/advanced#bookmarks-v220)           | _String_ or [Bookmark](/docs/v3/advanced#bookmark-type) | _undefined_ |
...
| Prop name |                                 Description                                 |                                            Type |     Default |
|-----------|:---------------------------------------------------------------------------:|------------------------------------------------:|------------:|
| src       |         Source of the image. [See more](/docs/v3/components#source-object)          |                                 _Source object_ | _undefined_ |
| source    |            Alias of _src_. [See more](/docs/v3/components#source-object)            |                                 _Source object_ | _undefined_ |
| style     |                  Defines view styles. [See more](/docs/v3/styling)                  |                               _Object_, _Array_ | _undefined_ |
| debug     |  Enables debug mode on view bounding box. [See more](/docs/v3/advanced#debugging)   |                                       _Boolean_ |     _false_ |
| fixed     | Renders component in all wrapped pages. [See more](/docs/v3/advanced#page-wrapping) |                                       _Boolean_ |     _false_ |
...
| Prop name           |                                       Description                                       |                                            Type |     Default |
|---------------------|:---------------------------------------------------------------------------------------:|------------------------------------------------:|------------:|
| wrap                |     Enables/disables page wrapping for element. [See more](/docs/v3/advanced#page-wrapping)     |                                       _Boolean_ |      _true_ |
| render              |     Renders dynamic content based on context. [See more](/docs/v3/advanced#dynamic-content)     |                                      _Function_ | _undefined_ |
| style               |                        Defines view styles. [See more](/docs/v3/styling)                        |                               _Object_, _Array_ | _undefined_ |
| debug               |        Enables debug mode on view bounding box. [See more](/docs/v3/advanced#debugging)         |                                       _Boolean_ |     _false_ |
| fixed               |       Renders component in all wrapped pages. [See more](/docs/v3/advanced#page-wrapping)       |                                       _Boolean_ |     _false_ |
| hyphenationCallback | Specify hyphenation callback at a text level. See [hypthenation](/docs/v3/advanced#hyphenation) |                                      _Function_ | _undefined_ |
| id                  |           Destination ID to be linked to. [See more](/docs/v3/advanced#destinations-v200)            |                                        _String_ | _undefined_ |
| bookmark            |               Attach bookmark to element. [See more](/docs/v3/advanced#bookmarks-v220)               | _String_ or [Bookmark](/docs/v3/advanced#bookmark-type) | _undefined_ |
...
| Prop name |                                          Description                                          |                                            Type |     Default |
|-----------|:---------------------------------------------------------------------------------------------:|------------------------------------------------:|------------:|
| src       | Valid URL or destination ID. ID must be prefixed with `#`. [See more](/docs/v3/advanced#destinations-v200) |                                        _String_ | _undefined_ |
| wrap      |         Enable/disable page wrapping for element. [See more](/docs/v3/advanced#page-wrapping)         |                                       _Boolean_ |      _true_ |
| style     |                           Defines view styles. [See more](/docs/v3/styling)                           |                               _Object_, _Array_ | _undefined_ |
| debug     |           Enables debug mode on view bounding box. [See more](/docs/v3/advanced#debugging)            |                                       _Boolean_ |     _false_ |
| fixed     |          Render component in all wrapped pages. [See more](/docs/v3/advanced#page-wrapping)           |                                       _Boolean_ |     _false_ |
...
Refer to [on the fly rendering](/docs/v3/advanced#on-the-fly-rendering-web-only) for more information.
