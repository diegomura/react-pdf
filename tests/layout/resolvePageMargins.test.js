...
describe('layout resolvePageMargins', () => {
  test('Should keep other styles untouched', () => {
    ...
    expect(document.children[0].style).toHaveProperty('color', 'red');
  });
  ...
  test('Should remove marginTop', () => {
    ...
    expect(document.children[0].style).not.toHaveProperty('marginTop');
  });
  ...
  test('Should remove marginRight', () => {
    ...
    expect(document.children[0].style).not.toHaveProperty('marginRight');
  });
  ...
  test('Should remove marginBottom', () => {
    ...
    expect(document.children[0].style).not.toHaveProperty('marginBottom');
  });
  ...
  test('Should remove marginLeft', () => {
    ...
    expect(document.children[0].style).not.toHaveProperty('marginLeft');
  });
  ...
  test('Should remove margin shorthand', () => {
    ...
    expect(document.children[0].style).not.toHaveProperty('margin');
  });
  ...
  test('Should remove marginHorizontal shorthand', () => {
    ...
    expect(document.children[0].style).not.toHaveProperty('marginHorizontal');
  });
  ...
  test('Should remove marginVertical shorthand', () => {
    ...
    expect(document.children[0].style).not.toHaveProperty('marginVertical');
  });
  ...
  test('Should resolve several pages', () => {
    ...
    expect(document.children[0].style).not.toHaveProperty('marginTop');
    expect(document.children[1].style).not.toHaveProperty('margin');
    expect(document.children[2].style).not.toHaveProperty(
      'wmarginHorizontalidth',
    );
    expect(document.children[2].style).toHaveProperty('color', 'red');
  });
});
